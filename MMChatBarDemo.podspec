#
# Be sure to run `pod lib lint MMChatBarDemo.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = <<-DESC
                MMChatBarDemo --- MQH chatbar,you should get it now
                       DESC
  ...
  s.source_files = 'MMChatBarClass/*.swift'
